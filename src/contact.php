...
function getContactDetails($contactTag)
{  
   $userfile= file_get_contents("contacts.txt");
   $users = explode("\n",$userfile);

   

   list($addTag , $addressValue) = explode(":" , $users[0]);
   list($phoneTag , $phoneValue) = explode(":" , $users[1]);
   list($emailTag , $emailValue) = explode(":" , $users[2]);
